...
Static testing involves testing and reviewing resources related to the software without executing it, e.g. reviewing test objects, code, or designs, while dynamic testing evaluates the software by execution to test its actual behaviour against its requirements.
