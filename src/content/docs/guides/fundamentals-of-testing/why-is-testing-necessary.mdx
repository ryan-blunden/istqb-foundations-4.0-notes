...
6. **Performance and reliability**  
   ...
   Apparently, Docker is important—maybe so QA can run apps locally the same way they're run in production.  
   **TODO**: Write an article on the importance of Docker for local deployment replication.  
   **Tools**: Mimic production load and stress testing.  
   **TODO**: Research the state of performance testing and what sophisticated teams are doing.​⬤