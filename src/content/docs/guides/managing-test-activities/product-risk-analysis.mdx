...
- Project timeline may be too aggresive, leading to rushed developemnt and inadequate testing.
- If testing is comprimised, quality is comprimised which is not acceptable. But scope can be reduced whcih doesn't inmpact quality.
- Don't skimp on quality just to follow a plan and get all the things done.

5. Financial Risks:  
- Budget allocated may be insufficient due to unforseen costs
