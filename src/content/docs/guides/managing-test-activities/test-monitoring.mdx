...
TODO: Investigate different test monitoring reports, e.g. number of stories, selection criteria, tests implemented.
...
- Managing changes and risks: Adapt quickly to ensure tests are still relevent and priotized correctly.
