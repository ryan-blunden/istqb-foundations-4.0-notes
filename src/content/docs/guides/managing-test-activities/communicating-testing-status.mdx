...
- Provide clear and consise data points

## Several ways to communicate test status:

It's not about choosing one or the other. These are complimentary but of course, you always need data that can be consumed async such as dashboards and reports.
...
<FAQList title="FAQs">
  <FAQ title="How can you communicate the status of testing?">
    No one best way. Different options for different folks who prefer absorbing information in different ways, such as stand-ups (talking), Power BI (stats), Jira board, dashboards.
  </FAQ>
</FAQList>