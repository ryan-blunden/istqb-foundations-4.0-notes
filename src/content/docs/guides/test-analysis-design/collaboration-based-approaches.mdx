...
Yes, a good developer ask similar questions, but the point, is that by working collaboratively during the story writing process, testers can suggest things the PM, BA, or developer may have missed.
...
- Helps reach consensus with stakeholders and developers s what's required is clear and documented
- Describing scenarios: how it will behave under normal and abnormal conditions, e.g. incorrect input or unexpected user behavior
...
- Extends TDD by incorporating the perspectives of business stakeholders
