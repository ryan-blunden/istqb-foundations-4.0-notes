...
Improves quality and development velocity by saving the time otherwise used in fixing the issue once it's been implemented. It's about reducing unecessary rework.
